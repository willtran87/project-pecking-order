...
static func create_theme() -> Theme:
	...
	theme.set_color(&"font_disabled_color", &"Button", MUTED.darkened(0.18))
	theme.set_font_size(&"font_size", &"Button", 14)
	theme.set_stylebox(&"normal", &"Button", _box(NAVY_RAISED, Color("455665"), 6, 1))
	...
	theme.set_stylebox(&"focus", &"Button", _outline_box(BRASS, 6, 2))
	...
	theme.set_font_size(&"font_size", &"UpgradeButton", 13)
	...
	theme.set_font_size(&"font_size", &"DecisionChoiceButton", 14)
