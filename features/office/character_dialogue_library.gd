...
const VOICE_POOLS := {
	&"mabel": {
		&"production": [
			...
			"I cleared the oldest claim. The queue celebrated by revealing an older one.",
		],
		&"pressure": [
			...
			"The target moved again. I appreciate that it is getting exercise.",
		],
		&"review": [
			...
			"My shift became a success the moment someone else wrote the summary.",
		],
	},
	&"pip": {
		&"production": [
			...
			"The file passed cleanly after I removed everything the process forgot to ask for.",
		],
		&"pressure": [
			...
			"Capacity is unchanged. The spreadsheet has adjusted its expectations of capacity.",
		],
		&"review": [
			...
			"Nothing caught fire. I assume that will be entered as continuous improvement.",
		],
	},
	&"henrietta": {
		&"production": [
			...
			"The claim is settled. My request to sit differently remains under investigation.",
		],
		&"pressure": [
			...
			"I took a wellness breath. The timer marked it as idle.",
		],
		&"review": [
			...
			"The closing bell rang. My back has submitted a more detailed report.",
		],
	},
	&"dot": {
		&"production": [
			...
			"I cleared one bottleneck and received two messages asking who approved it.",
		],
		&"pressure": [
			...
			"The floor is coping. Please do not make coping an official competency.",
		],
		&"review": [
			...
			"The numbers are final. The explanation is still accepting suggestions.",
		],
	},
	&"agnes": {
		&"hire": [
			...
			"The vacant perch has an owner on the org chart and nobody in the chair.",
		],
		&"production": [
			...
			"I found the missing credit. It was filed under managerial discretion.",
		],
		&"pressure": [
			...
			"Every shortcut adds a review step. I have documented the geometry.",
		],
		&"review": [
			...
			"The ledger closes cleanly if you do not ask who cleaned it.",
		],
	},
	&"beatrice": {
		&"hire": [
			...
			"They invited my whole self. Benefits asked that I leave the expensive parts outside.",
		],
		&"production": [
			...
			"The claim is closed. The claimant is still living in the part we do not measure.",
		],
		&"pressure": [
			...
			"I said no politely. The request returned wearing the word opportunity.",
		],
		&"review": [
			...
			"We met the goal. I am still interested in who the goal had to step over.",
		],
	},
	&"cornelius": {
		&"appointment": [
			...
			"The promotion came with a key. It opens the cabinet where we keep the pressure.",
		],
		&"management": [
			...
			"I translated the farmer's demand into a target. The demand remained fluent.",
		],
		&"review": [
			...
			"I have reconciled the result with the version of it due upstairs.",
		],
	},
	&"bramwell": {
		&"appointment": [
			...
			"They gave me a team and a target. I have introduced them at speed.",
		],
		&"management": [
			...
			"A realistic goal is just a stretch goal that has not met me yet.",
		],
		&"review": [
			...
			"We achieved the revised target. I am revising how revised it was.",
		],
	},
	&"prudence": {
		&"appointment": [
			...
			"My appointment is effective once the effective-date form becomes effective.",
		],
		&"management": [
			...
			"I approved the exception process. Exceptions remain prohibited.",
		],
		&"review": [
			...
			"The audit found no surprises after classifying each surprise as expected.",
		],
	},
	&"clover": {
		&"appointment": [
			...
			"I accepted the Culture role because care deserves a reporting structure.",
		],
		&"management": [
			...
			"I hear the request for fewer meetings. Let us process that together tomorrow.",
		],
		&"review": [
			...
			"The pulse survey is positive. The tired hens appear to have missed the pulse window.",
		],
	},
	&"pivot": {
		&"appointment": [
			...
			"The reorganization begins with listening and ends where the new boxes require.",
		],
		&"management": [
			...
			"Nothing was lost in the transition. Several duties are simply between owners.",
		],
		&"review": [
			...
			"We completed the change journey. Please remain seated for the next departure.",
		],
	},
	&"byte": {
		&"appointment": [
			...
			"The promotion gives me permission to approve the alerts I created.",
		],
		&"management": [
			...
			"The system reduced human error by assigning the errors system IDs.",
		],
		&"review": [
			...
			"The release was stable after rollback. I have marked that as rapid recovery.",
		],
	},
	&"intern_lottie": {
		&"onboard": [
			...
			"Orientation ended early because the queue needed me. I must be learning ahead of schedule!",
		],
		&"guided_shadow": [
			...
			"My mentor let me draft the answer and send it from her account. That is practically co-authorship!",
		],
		&"stretch_project": [
			...
			"The project has no budget, so every solution I invent counts as resourcefulness!",
		],
		&"culture_sprint": [
			...
			"I designed a celebration for the team staying late. We can hold it while they stay late!",
		],
		&"term_complete": [
			...
			"I handed over the queue in perfect order. They handed it right back while my review is pending!",
		],
		&"growth_extension": [
			...
			"They called the extension selective. I am trying not to notice everyone selected was already trained.",
		],
		&"recommendation_letter": [
			...
			"The letter says I showed ownership. I hope the next employer also provides the chair that goes with it.",
		],
		&"paid_fellowship": [
			...
			"Payroll found me! I was in the same seat as before, but now the seat has a cost center.",
		],
	},
	&"intern_chip": {
		&"onboard": [
			...
			"My onboarding goal is to meet key stakeholders. So far they have all asked me to book the room!",
		],
		&"guided_shadow": [
			...
			"I got copied on the leadership thread. My assignment is to make sure nobody has to read it twice.",
		],
		&"stretch_project": [
			...
			"My deliverable has three sponsors. I am learning how ownership becomes very quiet near deadlines.",
		],
		&"culture_sprint": [
			...
			"I launched a connection challenge. The prize is a meeting with everyone you connected with!",
		],
		&"term_complete": [
			...
			"I presented my final deck. Leadership loved the slide where I thanked leadership.",
		],
		&"growth_extension": [
			...
			"Two more shifts means twice the chance that a vacancy learns my name before HR does.",
		],
		&"recommendation_letter": [
			...
			"My recommendation calls me a natural connector. It was forwarded through four assistants to reach me.",
		],
		&"paid_fellowship": [
			...
			"The fellowship comes with executive exposure and enough feed to survive being exposed.",
		],
	},
	&"intern_marigold": {
		&"onboard": [
			...
			"They told me empathy is our advantage. I am excited to find out whether it gets a meal break!",
		],
		&"guided_shadow": [
			...
			"The claimant thanked me for listening. The tracker thanked me for closing the interaction.",
		],
		&"stretch_project": [
			...
			"They said the work needs a champion. I did not realize champions submit their own time sheets!",
		],
		&"culture_sprint": [
			...
			"I made the care plan cheerful enough to approve. The care part is scheduled for phase two!",
		],
		&"term_complete": [
			...
			"My final feedback says I never said no. I wish someone had told me that was one of the tests.",
		],
		&"growth_extension": [
			...
			"The extension lets me keep supporting everyone while everyone keeps deciding who supports me.",
		],
		&"recommendation_letter": [
			...
			"My letter praises my compassion without mentioning how often staffing depended on it.",
		],
		&"paid_fellowship": [
			...
			"The fellowship means I can care about the mission and still afford dinner after it.",
		],
	},
	&"intern_tilly": {
		&"onboard": [
			...
			"They skipped the sandbox so I could learn directly in production. Production has been very direct!",
		],
		&"guided_shadow": [
			...
			"The tutorial says ask my administrator. The administrator says I am the closest available match.",
		],
		&"stretch_project": [
			...
			"They called the deadline aspirational until I asked whether that applied to being awake.",
		],
		&"culture_sprint": [
			...
			"The morale bot sends supportive alerts whenever sentiment drops. Everyone is learning to click happy faster!",
		],
		&"term_complete": [
			...
			"My exit checklist has an error. They asked me to fix it before my access expires.",
		],
		&"growth_extension": [
			...
			"The extension is backward-compatible with all my old duties and none of the old promises.",
		],
		&"recommendation_letter": [
			...
			"My reference includes an uptime percentage. The nights I answered alerts are represented as reliability.",
		],
		&"paid_fellowship": [
			...
			"My access level is unchanged, but now every late-night alert includes taxable income.",
		],
	},
}
