    ...
    async function startGodot() {
      try {
		...
		const localPreviewArgs: Record<string, string> = {
			...
			"probation-report": "--capture-campaign-report",
			"probation-report-opportunity": "--capture-campaign-report-opportunity",
			"probation-report-risk": "--capture-campaign-report-risk",
			"promotion-order-tracker": "--capture-campaign-promotion-tracker",
			"promotion-order-ready": "--capture-campaign-promotion-ready",
			"goal-cause-locator": "--capture-goal-cause-locator",
			"goal-cause-fallback": "--capture-goal-cause-fallback",
			"goal-driver-route": "--capture-goal-driver-route",
			"goal-driver-flock-care": "--capture-goal-driver-flock-care",
			"goal-driver-farmer-standing": "--capture-goal-driver-farmer-standing",
			"goal-driver-coop-controls": "--capture-goal-driver-coop-controls",
			"goal-driver-live-files": "--capture-goal-driver-live-files",
			"goal-driver-live-files-empty": "--capture-goal-driver-live-files-empty",
			"senior-policy-receipt": "--capture-senior-policy-receipt",
