# Professional Gameplay Completion Resolution

This pass closes the approved 23-item gameplay brief by strengthening the existing office, simulation, Active Playbook, flock, rival, progression, and review systems. It adds no parallel economy, roster, claim queue, or save authority.
...
| # | Approved item | Resolution and authority |
|---:|---|---|
| 1 | Phase-gated HUD | Office presentation promotes only Plan, Pick File, Pick Hen, Work, Decision, or Review for the live phase. |
| 2 | Never show unusable decisions | Route and assignment groups remain hidden until their prerequisite physical step. |
| 3 | One physical interaction chain | All core actions expose Select, Preview, Commit, Land. |
| 4 | World-first previews | Guidance targets the office object, affected hen, ghost path, and result destination. |
| 5 | Context-sensitive controls | Pointer, Confirm, and Cancel are primary; shortcuts are optional. |
| 6 | Stronger focus mode | One primary cue and at most two supporting metrics are projected per phase. |
...
| 14 | Meaningful environmental timing | One situational office hotspot is promoted for each shift phase. |
| 15 | Chicken initiative and trust | Existing trust-gated hen proposals stay optional, bounded, and penalty-free. |
| 16 | Visible transformations | Rewards and chapters identify concrete office, flock, equipment, relationship, rival, or verb changes. |
| 17 | Reward anticipation | Trophy, music, office-activity, and prepared-delivery cues precede major rewards. |
| 18 | Choice-driven celebrations | The player chooses Flock, Office, Standing, or Mastery before the spectacle lands. |
| 19 | Fail-forward consequences | Recovery contracts, temporary rules, favors, and comeback wagers preserve banked rewards. |
| 20 | Mastery encourages variety | Six no-FOMO challenges reward different approaches without daily streak pressure. |
| 21 | Chapter transformations | Chapter presentation names population, equipment, relationship, rival, and verb changes. |
| 22 | Compelling next-shift hook | Review promises one claimant, furnishing, rival, career, or hero-file change. |
| 23 | Real five-person test | The exact unaided protocol and thresholds are packaged; results remain awaiting real participants. |
