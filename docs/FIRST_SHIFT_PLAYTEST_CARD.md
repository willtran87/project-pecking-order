# First-Shift Comprehension Session Card

Use this card with **five new participants** who have not watched another person play. Run one fresh file per participant. Do not explain controls, point at targets, or answer strategy questions; record any instruction as external help.
...
Current candidate status: **five unfamiliar-player sessions pending**. Automated checks and authored review fixtures are not participant evidence.

- First screen element the participant looks toward
...
- With too little money for helpful care, whether Later feels safe and no one mistakes quota pressure for a recommended kindness
...
- Whether browsing another goal is understood as preview only, and output, shell safety, and flock wellbeing feel meaningfully different
- After exceeding a shell-goal limit, whether “GOAL MISSED · QUOTA STILL COUNTS” encourages continuing the shift without implying lost earnings
- Whether quieter review controls make the hen's contribution and Continue clear while Staff / Cases and Build remain discoverable through Details
...
- Median clarity is at least 4/5 and median desire-to-continue is at least 4/5.

Use the existing local, consent-based session export and `usability-playtest-evidence.template.json`. Do not mark the evidence gate complete until all five real sessions are attached and independently validated.
